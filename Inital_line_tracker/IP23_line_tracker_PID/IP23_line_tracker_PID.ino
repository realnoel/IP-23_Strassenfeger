...
int error;
int previousError = 0;
int smallError = defaultSpeed * 0.27;    // Need to calibrate this parameter
int mediumError = defaultSpeed * 0.8;  // Need to calibrate this parameter
int bigError = defaultSpeed * 1.8;     // Need to calibrate this parameter
bool stopped = false;
