...
int competition_track_part1[] = {0, 1, 0, 4, 0, 1, 0, 9, 8};
...
void task_1()
{
    ...
    if (deponie_gewesen == false)
    {
        ...
        else if (competition_track_part1[can_counter] == 9)
        {
    ...
    else
    {
        ...
        else if (competition_track_part2[can_counter] == 12)
        {
